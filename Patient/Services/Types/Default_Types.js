...
export const BASE_URL = 'https://widesparklyboat9.conveyor.cloud';
// export const BASE_URL = 'https://192.168.1.12:45455';
export const PASSBASE_BASE_URL_IDENTITIES =
...
export const RETRIEVE_SOURCE = 'https://test-sources.paymongo.com/sources?id=';
...
export const GET_NOTIFICATION_LIST_ALL = 'GET_NOTIFICATION_LIST_ALL';


export const SET_TOKEN = 'SET_TOKEN';
export const PASSBASE_STATUS = 'PASSBASE_STATUS';
export const REFRESH_PAYMENT = 'REFRESH_PAYMENT';
export const REQUEST_CALLBACK = 'REQUEST_CALLBACK';
export const REQUEST_OTP_CALLBACK = 'REQUEST_OTP_CALLBACK';
export const REQUEST_UPDATE_PASSWORD_CALLBACK = 'REQUEST_UPDATE_PASSWORD_CALLBACK';
export const REQUEST_GET_OTP_CALLBACK = 'REQUEST_GET_OTP_CALLBACK';
